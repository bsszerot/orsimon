...
print "<TR><TD CLASS=\"HEAD\"><A HREF=\"$base_url/cgi/get_pga_sorts_exec.cgi?order_field=HASH_VALUE\" TARGET=\"cont\">HASH_VALUE</A></TD>
           <TD CLASS=\"HEAD\"><A HREF=\"$base_url/cgi/get_pga_sorts_exec.cgi?order_field=SQL_TEXT\" TARGET=\"cont\">SQL_TEXT</A></TD>
           <TD CLASS=\"HEAD\"><A HREF=\"$base_url/cgi/get_pga_sorts_exec.cgi?order_field=SORTS\" TARGET=\"cont\">SORTS</A></TD>
           <TD CLASS=\"HEAD\"><A HREF=\"$base_url/cgi/get_pga_sorts_exec.cgi?order_field=EXECUTIONS\" TARGET=\"cont\">EXECUTIONS</A></TD>
           </TR>" ;

$count_rows = 0 ;
while (my ($hash_value,$sql_text,$sorts,$executions) = $sth->fetchrow_array() ) {
      $count_rows += 1 ;
      printf("<TR><TD CLASS=\"SZDATA\">%s</TD>
                  <TD CLASS=\"SZDATA\" STYLE=\"widht: 400pt;\">%s</TD>
                  <TD CLASS=\"NUMDATA\">%s</TD>
                  <TD CLASS=\"NUMDATA\">%s</TD>
              </TR>\n",$hash_value,$sql_text,$sorts,&show_razryads($executions)) ;
      }
