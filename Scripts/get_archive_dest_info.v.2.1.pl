...
&print_html_head("Информация об archivelog destination") ;
...
&print_archivelogs_navigation(3) ;
...
print "<TR><TD>" ;
$request = 'select DEST_ID,DEST_NAME,STATUS,BINDING,NAME_SPACE,TARGET,ARCHIVER,SCHEDULE,DESTINATION,LOG_SEQUENCE,REOPEN_SECS,DELAY_MINS,NET_TIMEOUT,PROCESS,REGISTER,TO_CHAR(FAIL_DATE,\'YYYY-MM-DD HH24:MI:SS\'),FAIL_SEQUENCE,FAIL_BLOCK,
                   FAILURE_COUNT,MAX_FAILURE,ERROR,ALTERNATE,DEPENDENCY,REMOTE_TEMPLATE,QUOTA_SIZE,QUOTA_USED,MOUNTID,TRANSMIT_MODE,ASYNC_BLOCKS,AFFIRM,TYPE from v$archive_dest ORDER BY ' . $order_field ;

my $sth = $dbh->prepare($request) ;
$sth->execute();
# вывести непосредственно контент
print "<TABLE BORDER=\"1\" CELLSPACING=\"0\" CELLPADDING=\"0\" STYLE=\"width: 100%;\">" ;
print "<TR><TD CLASS=\"HEAD\"><A HREF=\"$base_url/cgi/get_archive_dest_info.cgi?order_field=DEST_ID\" TARGET=\"cont\">DEST ID</A></TD>
           <TD CLASS=\"HEAD\"><A HREF=\"$base_url/cgi/get_archive_dest_info.cgi?order_field=DEST_NAME\" TARGET=\"cont\">DEST_NAME</A></TD>
           <TD CLASS=\"HEAD\"><A HREF=\"$base_url/cgi/get_archive_dest_info.cgi?order_field=STATUS\" TARGET=\"cont\">STATUS</A></TD>
           <TD CLASS=\"HEAD\"><A HREF=\"$base_url/cgi/get_archive_dest_info.cgi?order_field=BINDING\" TARGET=\"cont\">BINDING</A></TD>
           <TD CLASS=\"HEAD\"><A HREF=\"$base_url/cgi/get_archive_dest_info.cgi?order_field=NAME_SPACE\" TARGET=\"cont\">NAME_SPACE</A></TD>
           <TD CLASS=\"HEAD\"><A HREF=\"$base_url/cgi/get_archive_dest_info.cgi?order_field=TARGET\" TARGET=\"cont\">TARGET</A></TD>
           <TD CLASS=\"HEAD\"><A HREF=\"$base_url/cgi/get_archive_dest_info.cgi?order_field=ARCHIVER\" TARGET=\"cont\">ARCHIVER</A></TD>
           <TD CLASS=\"HEAD\"><A HREF=\"$base_url/cgi/get_archive_dest_info.cgi?order_field=SCHEDULE\" TARGET=\"cont\">SCHEDULE</A></TD>
           <TD CLASS=\"HEAD\"><A HREF=\"$base_url/cgi/get_archive_dest_info.cgi?order_field=DESTINATION\" TARGET=\"cont\">DESTINATION</A></TD>
           <TD CLASS=\"HEAD\"><A HREF=\"$base_url/cgi/get_archive_dest_info.cgi?order_field=LOG_SEQUENCE\" TARGET=\"cont\">LOG_SEQUENCE</A></TD>
           <TD CLASS=\"HEAD\"><A HREF=\"$base_url/cgi/get_archive_dest_info.cgi?order_field=REOPEN_SECS\" TARGET=\"cont\">REOPEN_SECS</A></TD>
           <TD CLASS=\"HEAD\"><A HREF=\"$base_url/cgi/get_archive_dest_info.cgi?order_field=DELAY_MINS\" TARGET=\"cont\">DELAY_MINS</A></TD>
           <TD CLASS=\"HEAD\"><A HREF=\"$base_url/cgi/get_archive_dest_info.cgi?order_field=NET_TIMEOUT\" TARGET=\"cont\">NET_TIMEOUT</A></TD>
           <TD CLASS=\"HEAD\"><A HREF=\"$base_url/cgi/get_archive_dest_info.cgi?order_field=PROCESS\" TARGET=\"cont\">PROCESS</A></TD>
           <TD CLASS=\"HEAD\"><A HREF=\"$base_url/cgi/get_archive_dest_info.cgi?order_field=REGISTER\" TARGET=\"cont\">REGISTER</A></TD>
           <TD CLASS=\"HEAD\"><A HREF=\"$base_url/cgi/get_archive_dest_info.cgi?order_field=FAIL_DATE\" TARGET=\"cont\">FAIL_DATE</A></TD>
           <TD CLASS=\"HEAD\"><A HREF=\"$base_url/cgi/get_archive_dest_info.cgi?order_field=FAIL_SEQUENCE\" TARGET=\"cont\">FAIL_SEQUENCE</A></TD>
           <TD CLASS=\"HEAD\"><A HREF=\"$base_url/cgi/get_archive_dest_info.cgi?order_field=FAIL_BLOCK\" TARGET=\"cont\">FAIL_BLOCK</A></TD>
           <TD CLASS=\"HEAD\"><A HREF=\"$base_url/cgi/get_archive_dest_info.cgi?order_field=FAILURE_COUNT\" TARGET=\"cont\">FAILURE_COUNT</A></TD>
           <TD CLASS=\"HEAD\"><A HREF=\"$base_url/cgi/get_archive_dest_info.cgi?order_field=MAX_FAILURE\" TARGET=\"cont\">TYPE</A></TD>
           <TD CLASS=\"HEAD\"><A HREF=\"$base_url/cgi/get_archive_dest_info.cgi?order_field=ERROR\" TARGET=\"cont\">ERROR</A></TD>
           <TD CLASS=\"HEAD\"><A HREF=\"$base_url/cgi/get_archive_dest_info.cgi?order_field=ALTERNATE\" TARGET=\"cont\">ALTERNATE</A></TD>
           <TD CLASS=\"HEAD\"><A HREF=\"$base_url/cgi/get_archive_dest_info.cgi?order_field=DEPENDENCY\" TARGET=\"cont\">DEPENDENCY</A></TD>
           <TD CLASS=\"HEAD\"><A HREF=\"$base_url/cgi/get_archive_dest_info.cgi?order_field=REMOTE_TEMPLATE\" TARGET=\"cont\">REMOTE_TEMPLATE</A></TD>
           <TD CLASS=\"HEAD\"><A HREF=\"$base_url/cgi/get_archive_dest_info.cgi?order_field=QUOTA_SIZE\" TARGET=\"cont\">QUOTA_SIZE</A></TD>
           <TD CLASS=\"HEAD\"><A HREF=\"$base_url/cgi/get_archive_dest_info.cgi?order_field=QUOTA_USED\" TARGET=\"cont\">QUOTA_USED</A></TD>
           <TD CLASS=\"HEAD\"><A HREF=\"$base_url/cgi/get_archive_dest_info.cgi?order_field=MOUNTID\" TARGET=\"cont\">MOUNTID</A></TD>
           <TD CLASS=\"HEAD\"><A HREF=\"$base_url/cgi/get_archive_dest_info.cgi?order_field=TRANSMIT_MODE\" TARGET=\"cont\">TRANSMIT_MODE</A></TD>
           <TD CLASS=\"HEAD\"><A HREF=\"$base_url/cgi/get_archive_dest_info.cgi?order_field=ASYNC_BLOCKS\" TARGET=\"cont\">ASYNC_BLOCKS</A></TD>
           <TD CLASS=\"HEAD\"><A HREF=\"$base_url/cgi/get_archive_dest_info.cgi?order_field=AFFIRM\" TARGET=\"cont\">AFFIRM</A></TD>
           <TD CLASS=\"HEAD\"><A HREF=\"$base_url/cgi/get_archive_dest_info.cgi?order_field=TYPE\" TARGET=\"cont\">TYPE</A></TD>
       </TR>" ;
$count_rows = 0 ;
while (my ($dest_id,$dest_name,$status,$binding,$name_space,$target,$archiver,$shedule,$destination,$log_sequence,$reopen_secs,$delay_mins,$net_timeout,$process,$register,$fail_date,$fail_sequence,$fail_block,$failure_count,$max_failure,$error,$alternate,$dependency,$remote_template,$quota_size, $quota_used,$mountid,$transmit_mode,$async_block,$affirm,$type) = $sth->fetchrow_array() ) {
      $count_rows += 1 ; 
      if ( $error eq "" ) { $error = "&nbsp;" ; } 
      if ( $destination eq "" ) { $destination = "&nbsp;" ; }
      if ( $fail_date eq "" ) { $fail_date = "&nbsp;" ; } 
      ...
      printf("<TR><TD CLASS=\"NUMDATA\">%s</TD>
                  ...
                  <TD CLASS=\"SZDATA\">%s</TD>
                  <TD CLASS=\"SZDATA\">%s</TD>
              </TR>\n",$dest_id,$dest_name,$status,$binding,$name_space,$target,$archiver,$shedule,$destination,&show_razryads($log_sequence),$reopen_secs,$delay_mins,$net_timeout,$process,$register,$fail_date,$fail_sequence,$fail_block,$failure_count,$max_failure,$error,$alternate,$dependency,$remote_template,$quota_size, $quota_used,$mountid,$transmit_mode,$async_block,$affirm,$type) ;
      }
print "<TR><TD CLASS=\"SZDATA\">Итого</TD><TD CLASS=\"NUMDATA\" COLSPAN=\"30\">$count_rows</TD></TR>\n" ;
print "</TABLE>" ;
$sth->finish();
$dbh->disconnect();
