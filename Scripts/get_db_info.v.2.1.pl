...
$pv{order_field} = "SEGMENT_NAME" ;
&get_forms_param() ;

$ENV{ORACLE_SID} = $current_connector ;

print "Content-Type: text/html\n\n"; 
&print_html_head("Информация о базе данных") ;
...
print "<FORM ACTION=\"$base_url/cgi/get_segments_definition.cgi\" METHOD=\"GET\">
...
# сформировать уточняющие фильтры для запроса статистики
   ...
   if ( $pv{srcptr} eq "0" || $pv{srcptr} eq "" ) { 
      $request = 'select OWNER, SEGMENT_NAME, PARTITION_NAME, SEGMENT_TYPE, TABLESPACE_NAME, HEADER_FILE, HEADER_BLOCK, BYTES, BLOCKS, EXTENTS, 
   ...
   print "<TR><TD CLASS=\"HEAD\"><A HREF=\"$base_url/cgi/get_segments_definition.cgi?order_field=OWNER&isfirst=$pv{isfirst}&srcptr=$pv{srcptr}&tbs_filter=$pv{tbs_filter}&name_filter=$pv{name_filter}&owner_filter=$pv{owner_filter}&type_filter=$pv{type_filter}\" TARGET=\"cont\">Владелец</A></TD>
              <TD CLASS=\"HEAD\"><A HREF=\"$base_url/cgi/get_segments_definition.cgi?order_field=SEGMENT_NAME&isfirst=$pv{isfirst}&srcptr=$pv{srcptr}&tbs_filter=$pv{tbs_filter}&name_filter=$pv{name_filter}&owner_filter=$pv{owner_filter}&type_filter=$pv{type_filter}\" TARGET=\"cont\">Имя сегмента</A></TD>
              <TD CLASS=\"HEAD\"><A HREF=\"$base_url/cgi/get_segments_definition.cgi?order_field=PARTITION_NAME&isfirst=$pv{isfirst}&srcptr=$pv{srcptr}&tbs_filter=$pv{tbs_filter}&name_filter=$pv{name_filter}&owner_filter=$pv{owner_filter}&type_filter=$pv{type_filter}\" TARGET=\"cont\">Имя партиции</A></TD>
              <TD CLASS=\"HEAD\"><A HREF=\"$base_url/cgi/get_segments_definition.cgi?order_field=SEGMENT_TYPE&isfirst=$pv{isfirst}&srcptr=$pv{srcptr}&tbs_filter=$pv{tbs_filter}&name_filter=$pv{name_filter}&owner_filter=$pv{owner_filter}&type_filter=$pv{type_filter}\" TARGET=\"cont\">Тип сегмента</A></TD>
              <TD CLASS=\"HEAD\"><A HREF=\"$base_url/cgi/get_segments_definition.cgi?order_field=TABLESPACE_NAME&isfirst=$pv{isfirst}&srcptr=$pv{srcptr}&tbs_filter=$pv{tbs_filter}&name_filter=$pv{name_filter}&owner_filter=$pv{owner_filter}&type_filter=$pv{type_filter}\" TARGET=\"cont\">Имя ТС</A></TD>
              <TD CLASS=\"HEAD\"><A HREF=\"$base_url/cgi/get_segments_definition.cgi?order_field=HEADER_FILE&isfirst=$pv{isfirst}&srcptr=$pv{srcptr}&tbs_filter=$pv{tbs_filter}&name_filter=$pv{name_filter}&owner_filter=$pv{owner_filter}&type_filter=$pv{type_filter}\" TARGET=\"cont\">HEADER_FILE</A></TD>
              <TD CLASS=\"HEAD\"><A HREF=\"$base_url/cgi/get_segments_definition.cgi?order_field=HEADER_BLOCK&isfirst=$pv{isfirst}&srcptr=$pv{srcptr}&tbs_filter=$pv{tbs_filter}&name_filter=$pv{name_filter}&owner_filter=$pv{owner_filter}&type_filter=$pv{type_filter}\" TARGET=\"cont\">HEADER_BLOCK</A></TD>
              <TD CLASS=\"HEAD\"><A HREF=\"$base_url/cgi/get_segments_definition.cgi?order_field=BYTES&isfirst=$pv{isfirst}&srcptr=$pv{srcptr}&tbs_filter=$pv{tbs_filter}&name_filter=$pv{name_filter}&owner_filter=$pv{owner_filter}&type_filter=$pv{type_filter}\" TARGET=\"cont\">Объём, байт</A></TD>
              <TD CLASS=\"HEAD\"><A HREF=\"$base_url/cgi/get_segments_definition.cgi?order_field=BLOCKS&isfirst=$pv{isfirst}&srcptr=$pv{srcptr}&tbs_filter=$pv{tbs_filter}&name_filter=$pv{name_filter}&owner_filter=$pv{owner_filter}&type_filter=$pv{type_filter}\" TARGET=\"cont\">Объём, блоков</A></TD>
              <TD CLASS=\"HEAD\"><A HREF=\"$base_url/cgi/get_segments_definition.cgi?order_field=EXTENTS&isfirst=$pv{isfirst}&srcptr=$pv{srcptr}&tbs_filter=$pv{tbs_filter}&name_filter=$pv{name_filter}&owner_filter=$pv{owner_filter}&type_filter=$pv{type_filter}\" TARGET=\"cont\">Занято экстентов</A></TD>
              <TD CLASS=\"HEAD\"><A HREF=\"$base_url/cgi/get_segments_definition.cgi?order_field=INITIAL_EXTENT&isfirst=$pv{isfirst}&srcptr=$pv{srcptr}&tbs_filter=$pv{tbs_filter}&name_filter=$pv{name_filter}&owner_filter=$pv{owner_filter}&type_filter=$pv{type_filter}\" TARGET=\"cont\">Начальный экстент, байт</A></TD>
              <TD CLASS=\"HEAD\"><A HREF=\"$base_url/cgi/get_segments_definition.cgi?order_field=NEXT_EXTENT&isfirst=$pv{isfirst}&srcptr=$pv{srcptr}&tbs_filter=$pv{tbs_filter}&name_filter=$pv{name_filter}&owner_filter=$pv{owner_filter}&type_filter=$pv{type_filter}\" TARGET=\"cont\">Следующий экстент, байт</A></TD>
              <TD CLASS=\"HEAD\"><A HREF=\"$base_url/cgi/get_segments_definition.cgi?order_field=MIN_EXTENTS&isfirst=$pv{isfirst}&srcptr=$pv{srcptr}&tbs_filter=$pv{tbs_filter}&name_filter=$pv{name_filter}&owner_filter=$pv{owner_filter}&type_filter=$pv{type_filter}\" TARGET=\"cont\">Минимально экстентов</A></TD>
              <TD CLASS=\"HEAD\"><A HREF=\"$base_url/cgi/get_segments_definition.cgi?order_field=MAX_EXTENTS&isfirst=$pv{isfirst}&srcptr=$pv{srcptr}&tbs_filter=$pv{tbs_filter}&name_filter=$pv{name_filter}&owner_filter=$pv{owner_filter}&type_filter=$pv{type_filter}\" TARGET=\"cont\">Максимально экстентов</A></TD>
              <TD CLASS=\"HEAD\"><A HREF=\"$base_url/cgi/get_segments_definition.cgi?order_field=PCT_INCREASE&isfirst=$pv{isfirst}&srcptr=$pv{srcptr}&tbs_filter=$pv{tbs_filter}&name_filter=$pv{name_filter}&owner_filter=$pv{owner_filter}&type_filter=$pv{type_filter}\" TARGET=\"cont\">PCT_INCREASE</A></TD>
              <TD CLASS=\"HEAD\"><A HREF=\"$base_url/cgi/get_segments_definition.cgi?order_field=FREELISTS&isfirst=$pv{isfirst}&srcptr=$pv{srcptr}&tbs_filter=$pv{tbs_filter}&name_filter=$pv{name_filter}&owner_filter=$pv{owner_filter}&type_filter=$pv{type_filter}\" TARGET=\"cont\">FREELISTS</A></TD>
              <TD CLASS=\"HEAD\"><A HREF=\"$base_url/cgi/get_segments_definition.cgi?order_field=FREELIST_GROUPS&isfirst=$pv{isfirst}&srcptr=$pv{srcptr}&tbs_filter=$pv{tbs_filter}&name_filter=$pv{name_filter}&owner_filter=$pv{owner_filter}&type_filter=$pv{type_filter}\" TARGET=\"cont\">FREELIST_GROUPS</A></TD>
              <TD CLASS=\"HEAD\"><A HREF=\"$base_url/cgi/get_segments_definition.cgi?order_field=RELATIVE_FNO&isfirst=$pv{isfirst}&srcptr=$pv{srcptr}&tbs_filter=$pv{tbs_filter}&name_filter=$pv{name_filter}&owner_filter=$pv{owner_filter}&type_filter=$pv{type_filter}\" TARGET=\"cont\">RELATIVE_FNO</A></TD>
              <TD CLASS=\"HEAD\"><A HREF=\"$base_url/cgi/get_segments_definition.cgi?order_field=BUFFER_POOL&isfirst=$pv{isfirst}&srcptr=$pv{srcptr}&tbs_filter=$pv{tbs_filter}&name_filter=$pv{name_filter}&owner_filter=$pv{owner_filter}&type_filter=$pv{type_filter}\" TARGET=\"cont\">BUFFER_POOL</A></TD>
              </TR>" ;

   $count_all = 0 ;
   while (my ( $owner,$segment_name,$partition_name,$segment_type,$tablespace_name,$header_file,$header_block,$bytes,$blocks,$extents,$initial_extent,$next_extent,$min_extents,$max_extents,$pct_increase,$freelists,$freelist_group,$relative_fno,$buffer_pool ) = $sth->fetchrow_array() ) {
         ...
         printf("<TR><TD CLASS=\"SZDATA\">%s</TD>
                     ...
                     <TD CLASS=\"NUMDATA\">%s</TD>
                     <TD CLASS=\"SZDATA\">%s</TD>
                     </TR>\n",$owner,$segment_name,$partition_name,$segment_type,$tablespace_name,&show_razryads($header_file),&show_razryads($header_block),
                              &show_razryads($bytes),&show_razryads($blocks),&show_razryads($extents),&show_razryads($initial_extent),
                              &show_razryads($next_extent),&show_razryads($min_extents),&show_razryads($max_extents),&show_razryads($pct_increase),
                              $freelists,$freelist_group,$relative_fno,$buffer_pool ) ;
         }
