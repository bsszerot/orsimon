...
sub print_temp_navigation($) { $active_tab{1} = "" ; $active_tab{2} = "" ; $active_tab{3} = "" ; 
    ...
    print "<TABLE CELLSPACING=\"0\" CELLPADDING=\"0\" STYLE=\"border: 0pt none; width: 100%;\">
           ...
           <TD STYLE=\"border: 2pt navy; border-style: solid $active_tab{1}; text-align: center;\">
               <A HREF=\"$base_url/cgi/get_temp_lmt_usage.cgi?order_field=BYTES_USED\" TARGET=\"cont\">LMT TEMP usage</A></TD>
           <TD STYLE=\"border: 2pt navy; border-style: none none solid none;\">&nbsp;&nbsp;&nbsp;&nbsp;</TD>
           <TD STYLE=\"border: 2pt navy; border-style: solid $active_tab{2}; text-align: center;\">
               <A HREF=\"$base_url/cgi/get_temp_segs_usage.cgi?order_field=USERNAME\" TARGET=\"cont\">Утилизация временных сегментов</A></TD>
           <TD STYLE=\"border: 2pt navy; border-style: none none solid none;\">&nbsp;&nbsp;&nbsp;&nbsp;</TD>
           </TR></TABLE>" ;
    }
...
$request = 'select USERNAME, SESSION_ADDR, SESSION_NUM, SQLADDR, SQLHASH, TABLESPACE, CONTENTS, SEGTYPE, SEGFILE# SEGFILE_N, SEGBLK# SEGBLK_N, EXTENTS, BLOCKS, SEGRFNO# SEGRFNO_N from V$TEMPSEG_USAGE ORDER BY ' . $order_field ;
                                 
my $sth = $dbh->prepare($request) ;
$sth->execute();
print "Content-Type: text/html\n\n"; 
&print_html_head("Утилизация сегментов временных файлов") ;

# добавить определение навигационно - оформительского механизма закладок
&print_temp_navigation(2) ;
...
print "<TR><TD CLASS=\"HEAD\"><A HREF=\"$base_url/cgi/get_temp_segs_usage.cgi?order_field=USERNAME\" TARGET=\"cont\">USERNAME</A></TD>
           <TD CLASS=\"HEAD\"><A HREF=\"$base_url/cgi/get_temp_segs_usage.cgi?order_field=SESSION_ADDR\" TARGET=\"cont\">SESSION ADDR</A></TD>
           <TD CLASS=\"HEAD\"><A HREF=\"$base_url/cgi/get_temp_segs_usage.cgi?order_field=SESSION_NUM\" TARGET=\"cont\">SESSION ADDR</A></TD>
           <TD CLASS=\"HEAD\"><A HREF=\"$base_url/cgi/get_temp_segs_usage.cgi?order_field=SQLADDR\" TARGET=\"cont\">SQL ADDR</A></TD>
           <TD CLASS=\"HEAD\"><A HREF=\"$base_url/cgi/get_temp_segs_usage.cgi?order_field=SQLHASH\" TARGET=\"cont\">SQL HASH</A></TD>
           <TD CLASS=\"HEAD\"><A HREF=\"$base_url/cgi/get_temp_segs_usage.cgi?order_field=TABLESPACE\" TARGET=\"cont\">TABLESPACE</A></TD>
           <TD CLASS=\"HEAD\"><A HREF=\"$base_url/cgi/get_temp_segs_usage.cgi?order_field=CONTENTS\" TARGET=\"cont\">CONTENTS</A></TD>
           <TD CLASS=\"HEAD\"><A HREF=\"$base_url/cgi/get_temp_segs_usage.cgi?order_field=SEGTYPE\" TARGET=\"cont\">SEGTYPE</A></TD>
           <TD CLASS=\"HEAD\"><A HREF=\"$base_url/cgi/get_temp_segs_usage.cgi?order_field=SEGFILE_N\" TARGET=\"cont\">SEGFILE\#</A></TD>
           <TD CLASS=\"HEAD\"><A HREF=\"$base_url/cgi/get_temp_segs_usage.cgi?order_field=SEGBLK_N\" TARGET=\"cont\">SEGBLK\#</A></TD>
           <TD CLASS=\"HEAD\"><A HREF=\"$base_url/cgi/get_temp_segs_usage.cgi?order_field=EXTENTS\" TARGET=\"cont\">EXTENTS</A></TD>
           <TD CLASS=\"HEAD\"><A HREF=\"$base_url/cgi/get_temp_segs_usage.cgi?order_field=BLOCKS\" TARGET=\"cont\">BLOCKS</A></TD>
           <TD CLASS=\"HEAD\"><A HREF=\"$base_url/cgi/get_temp_segs_usage.cgi?order_field=SEGRFNO_N\" TARGET=\"cont\">SEGRFNO\#</A></TD>
           </TR>" ;

$count_rows = 0 ; $sum_blocks = 0 ; $sum_extents = 0 ;
while (my ($username,$session_addr,$session_num,$sqladdr,$sqlhash,$tablespace,$contents,$segtype,$segfile_n,$segblk_n,$extents,$blocks,$segrfno_n) = $sth->fetchrow_array() ) {
      $count_rows += 1 ; $sum_blocks += $blocks ; $sum_extents += $extents ;
      ...
      printf("<TR><TD CLASS=\"SZDATA\">%s</TD>
                  ...
                  <TD CLASS=\"NUMDATA\">%s</TD>
                  <TD CLASS=\"NUMDATA\">%s</TD>
              </TR>\n",$username,$session_addr,$session_num,$sqladdr,$sqlhash,$tablespace,$contents,$segtype,$segfile_n,$segblk_n,$extents,$blocks,$segrfno_n) ;
      }
print "<TR><TD CLASS=\"SZDATA\" COLSPAN=\"10\">Итого:&nbsp;$count_rows<TD CLASS=\"NUMDATA\">$sum_extents</TD><TD CLASS=\"NUMDATA\">$sum_blocks</TD><TD>&nbsp;</TD></TR>\n" ;
print "</TABLE>" ;
print "</TD></TR></TABLE>" ;
$sth->finish();
$dbh->disconnect();                                        
